      ...
      const html = `
        <div style="font-family:sans-serif;max-width:600px">
          ...
          <table style="border-collapse:collapse;width:100%;margin-bottom:20px">
            ...
            ${record.discount_code ? `<tr><td style="padding:10px;font-weight:bold;border-bottom:1px solid #eee;color:#00B894">🎟️ Promo Code</td><td style="padding:10px;border-bottom:1px solid #eee;font-weight:700;color:#00B894">${record.discount_code}${record.tier_discount ? ` — ${Math.round(Number(record.tier_discount) * 100)}% off` : ""}</td></tr>` : ""}
            ...
            ${Number(record.sample_packets) > 0 ? `<tr><td style="padding:10px;font-weight:bold;border-bottom:1px solid #eee;color:#00B894">🎁 Free Samples</td><td style="padding:10px;border-bottom:1px solid #eee;font-weight:700;color:#00B894">Include ${record.sample_packets} sample packets (welcome gift)</td></tr>` : ""}
            ${Number(record.credit_applied) > 0 ? `<tr><td style="padding:10px;font-weight:bold;border-bottom:1px solid #eee;color:#0072BC">💳 Account Credit Applied</td><td style="padding:10px;border-bottom:1px solid #eee;font-weight:700;color:#0072BC">-$${Number(record.credit_applied).toFixed(2)} (Total above is the amount due)</td></tr>` : ""}
